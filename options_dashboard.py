...
with c1:
    st.markdown(f"""
    <div class="kpi-card" style="animation-delay:0.0s;min-height:220px">
        ...
        <div class="kpi-value cyan" style="font-size:1.9rem">{fmt(K,2)}</div>
...
with c2:
    ...
    st.markdown(f"""
    <div class="kpi-card" style="animation-delay:0.06s;min-height:220px">
        ...
        <div class="kpi-value {vc}" style="font-size:1.9rem">{fmt(prob*100,2)}%</div>
...
with c3:
    st.markdown(f"""
    <div class="kpi-card" style="animation-delay:0.12s;min-height:220px">
        ...
        <div class="kpi-value green" style="font-size:1.9rem">{fmt(prem,2)}</div>
...
with c4:
    st.markdown(f"""
    <div class="kpi-card" style="animation-delay:0.18s;min-height:220px">
        ...
        <div class="kpi-value gold" style="font-size:1.9rem">{fmt(marg_tot,0)} €</div>
